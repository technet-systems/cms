...
class Gallery_pic extends CI_Controller {
    ...
    public function index($data = FALSE) {
        ...
        if ($this->session->userdata('is_logged_in') == TRUE) {
            ...
            $this->load->view('admin/gallery_pic_v');
    ...
    public function update_pic_title() {
        // Wydobycie 'id' z adresu podanego przy 'action' w formularzu
        ...
        redirect('/admin/gallery_pic/show_gallery/'.$this->uri->segment(4), 'refresh');
        
    }
    
    public function update_pics() {
        // Konfiguracja dozwolonych typów plików do 'upload'u'
        $config = array(
            'upload_path' => './uploads',
            'allowed_types' => 'gif|jpg|png',
    ...
    public function fake_delete_pic() {
        // Ściągnięcie 4 elementu adresu URI
        $id = $this->uri->segment(5);

                        ...
                        <div class="col-xs-12 col-lg-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Galeria:
                                        <strong>
                                            <?php foreach($start as $item) { ?>
                                            
                                            <?php print $item->c1_title; ?>
                                ...
                                <div class="panel-body">
                                                    ...
                                                    <div class="modal fade" id="myModalChangeText<?php print $item->c11_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <?php print form_open('admin/gallery_pic/update_pic_title/'.$item->c11_c1_id.'/'.$item->c11_id); ?>
                                                    ...
                                                    <div class="modal fade" id="myModalChangePic<?php print $item->c11_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <?php print form_open_multipart('admin/gallery_pic/update_pics/'.$item->c11_c1_id.'/'.$item->c11_id); ?>
                                                    ...
                                                    <div class="modal fade" id="myModalDelete<?php print $item->c11_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <?php print form_open('admin/gallery_pic/fake_delete_pic/'.$item->c11_c1_id.'/'.$item->c11_id); ?>
                                    ...
                                    <div class="btn-group" role="group" aria-label="...">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalAddLink"><span class="glyphicon glyphicon-plus"></span> Dodaj zdjęcie</button>
                                    </div>
                                    <?php foreach($start as $item) { ?>
                                    ...
                                    <div class="modal fade" id="myModalAddLink" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <?php print form_open('admin/gallery_pic/add_pic_title/'.$item->c1_id); ?>

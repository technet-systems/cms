                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <h4 class="modal-title" id="myModalLabel">Edycja tekstu powitalnego</h4>
                                                                    <small>Ostatnie zmiany: <?php print $item->c1_timestamp; ?></small>
                                                                </div>
                                                                <?php print form_open('admin/content_start/update_article/'.$item->c1_id); ?>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-horizontal">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="header" class="col-sm-2 control-label">Tytuł</label>
                                                                            <div class="col-sm-10">
                                                                                <input type="text" name="title" value="<?php print $item->c1_title; ?>" class="form-control" placeholder="Musisz wpisać jakiś nagłówek!">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="header" class="col-sm-2 control-label">Podtytuł</label>
                                                                            <div class="col-sm-10">
                                                                                <input type="text" name="subtitle" value="<?php print $item->c1_subtitle; ?>" class="form-control" placeholder="Musisz wpisać jakiś nagłówek!">
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <div class="modal fade" id="myModalChangePic<?php print $item->c1_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <?php print form_open_multipart('admin/content_start/update_pic/'.$item->c1_id); ?>
                        ...
                        <div class="col-xs-12 col-lg-12">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-horizontal">
                                        <?php print form_open('admin/content_start/update_properties/1'); ?>
